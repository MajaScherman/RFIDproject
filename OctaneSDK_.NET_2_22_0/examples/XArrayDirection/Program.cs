    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                // Put the xArray into direction mode
                settings.XArray.Mode = XArrayMode.Direction;

                // Retrieve the DirectionConfig object stored on the reader so that we can
                // modify the settings we are interested in.
                DirectionConfig directionConfig = settings.XArray.Direction;
                ...
                List<ushort> enabledSectorIDs = new List<ushort> {2, 4, 6, 8};
                ...
                //directionConfig.TxPowerInDbm = 23;
